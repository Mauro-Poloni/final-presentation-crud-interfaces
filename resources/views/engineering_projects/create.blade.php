...
@section('content')
    ...
    <div class="max-w-3xl mx-auto bg-white shadow-2xl rounded-xl p-8 border-t-8 border-blue-900">
        <h2 class="text-3xl font-extrabold text-blue-900 mb-8 border-b border-gray-200 pb-4 flex items-center gap-3">
            <i data-lucide="file-plus" class="w-7 h-7 text-blue-600"></i> Register New Project
        </h2>

        <form action="{{ route('engineering_projects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="project_name" id="project_name"
                           class="w-full border-gray-300 rounded-lg p-3 focus:ring-blue-500 focus:border-blue-500 transition duration-150"
                           required>
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full border-gray-300 rounded-lg p-3 focus:ring-blue-500 focus:border-blue-500 transition duration-150 placeholder:italic placeholder:text-gray-400"
                              placeholder="Describe the project's purpose, goals, and requirements..."></textarea>
                </div>
            </div>

            <div>
                <label for="diagram" class="block font-semibold text-gray-700 mb-1 flex items-center gap-2">
                    <i data-lucide="layout-grid" class="w-5 h-5 text-blue-600"></i> Upload Diagram / Blueprint
                </label>
                <input type="file" name="diagram" id="diagram"
                       class="w-full border-gray-300 rounded-lg p-3 bg-gray-50 text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200 cursor-pointer">
            </div>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <button type="submit" class="bg-blue-700 text-white px-5 py-2.5 rounded-lg font-semibold shadow-md hover:bg-blue-800 transition duration-150 flex items-center gap-2 transform hover:scale-[1.01]">
                    <i data-lucide="send"></i> Submit Project
                </button>
            </div>
        </form>
    </div>
