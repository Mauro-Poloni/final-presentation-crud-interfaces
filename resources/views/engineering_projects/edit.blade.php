...
@section('content')
    ...
    <form action="{{ route('engineering_projects.update', $engineering_project) }}" method="POST" enctype="multipart/form-data"
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4"
                      class="mt-1 p-2 w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ old('description', $engineering_project->description) }}</textarea>
        </div>

        <div>
            <label class="block font-medium text-gray-700">Current Diagram</label>
        ...
        <div>
            <label for="diagram" class="block font-medium text-gray-700">Replace Diagram</label>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit"
                    class="bg-blue-700 hover:bg-blue-800 text-white px-5 py-2 rounded-md shadow-md flex items-center gap-2">
